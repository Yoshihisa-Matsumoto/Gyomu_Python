...
class TestBuildDocstringUpdatePlanWithRetry:
    @pytest.mark.asyncio
    async def test_returns_plan_when_first_attempt_is_valid(
        self,
    ...
    @pytest.mark.asyncio
    async def test_does_not_dump_plan_by_default(
        self,
        mocker: MockerFixture,
    ) -> None:
        foo = create_declaration_identity("foo")
    ...
    @pytest.mark.asyncio
    async def test_passes_retry_option_to_generator(
        self,
        mocker: MockerFixture,
    ) -> None:
        foo = create_declaration_identity("foo")
    ...
    @pytest.mark.asyncio
    async def test_combines_original_and_retry_plan(
        self,
        mocker: MockerFixture,
    ) -> None:
        foo = create_declaration_identity("foo")
    ...
    @pytest.mark.asyncio
    async def test_fails_after_five_attempts(
        self,
        mocker: MockerFixture,
    ) -> None:
        foo = create_declaration_identity("foo")
    ...
    @pytest.mark.asyncio
    async def test_failure_when_generation_fails(
        self,
        mocker: MockerFixture,
    ) -> None:
        foo = create_declaration_identity("foo")
...
class TestOverrideDocstringUpdatePlan:
    def test_filters_entries_not_in_context(
        self,
    ) -> None:
        foo = create_declaration_identity("foo")
    ...
    def test_filters_entries_when_retry_is_none(
        self,
    ) -> None:
        foo = create_declaration_identity("foo")
        unknown = create_declaration_identity("unknown")
    ...
    def test_adds_missing_entries_to_original_plan(
        self,
    ) -> None:
        foo = create_declaration_identity("foo")
        bar = create_declaration_identity("bar")
    ...
    def test_keeps_original_when_missing_entry_is_not_in_plan(
        self,
    ) -> None:
        foo = create_declaration_identity("foo")
        bar = create_declaration_identity("bar")
