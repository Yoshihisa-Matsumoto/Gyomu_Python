...
class CommonStatusCode(StatusCode):
    ...
    def static_initialize(cls):
        ...
        cls.TASK_GENERATE_ERROR = StatusCode._code_gen(cls.APP_ID, StatusCode.ERROR_DEVELOPER, 0x41,
                                                       ...
                                                       "ApplicationID:{0}\nTask Info ID:{1}\nParameter:{2}")
        cls.TASK_INSTANCE_GENERATE_ERROR = StatusCode._code_gen(cls.APP_ID, StatusCode.ERROR_DEVELOPER, 0x42,
                                                                "Task Instance can't be generated",
                                                                "ApplicationID:{0}\nTask Info ID:{1}\nTask Data ID:{2}\nParameter:{3}")
        cls.TASK_ALREADY_GENERATED = StatusCode._code_gen(cls.APP_ID, StatusCode.ERROR_DEVELOPER, 0x43,
                                                          "Task is already generated. Can't start twice in the same instance.",
                                                          "ApplicationID:{0}\nTask Info ID:{1}\nParameter:{2}\nTask Data ID:{3}")
        cls.TASK_EXECUTION_FAILED = StatusCode._code_gen(cls.APP_ID, StatusCode.ERROR_DEVELOPER, 0x44,
                                                         "Unknown Exception happens. Developer must handle exception in the target task.", "ApplicationID:{0}\nTask Info ID:{1}\nParameter:{2}\nTask Data ID:{3}")
        cls.TASK_LIBRARY_INTERNAL_ERROR = StatusCode._code_gen(cls.APP_ID, StatusCode.ERROR_DEVELOPER, 0x45,
        ...
        cls.TASK_INSTANCE_NOT_EXIST = StatusCode._code_gen(cls.APP_ID, StatusCode.ERROR_DEVELOPER, 0x47,
                                                           "Task Instance Not Found",
                                                           "ApplicationID:{0}\nTask Info ID:{1}\nTask Data ID:{2}\nInstance ID:{3}")
        cls.TASK_STATUS_INCONSISTENT = StatusCode._code_gen(cls.APP_ID, StatusCode.ERROR_DEVELOPER, 0x48,
        ...
        cls.INVALID_USER_ACCESS = StatusCode._code_gen(cls.APP_ID, StatusCode.ERROR_DEVELOPER, 0x4b,
